...
public class Survey {
	public static final String SURVEY_STATUS_INIT="未开启";
	public static final String SURVEY_STATUS_BEGIN="正在进行";
	public static final String SURVEY_STATUS_CHECK="未审核";
	public static final String SURVEY_STATUS_PASS="审核通过";
	public static final String SURVEY_STATUS_NOPASS="审核未通过";
    /**
     *
